    ...
    this.getHtmlListDiv = function() {
        ...
        if(this.books.length != 0) {
            for(forRBooks in this.books) { // read all books
                ...
                '<svg id="s_' + this.books[forRBooks]["bid"] + '"><use xlink:href="/files/cicons/cicons.svg?v=9#trash"></use></svg></a>' +
                '<div class="overlay" id="popdel_' + this.books[forRBooks]["bid"] + '"><div class="centerPopup"><div class="delPopup">' +
                    '<a class="closeDelPopup" href="#"><svg><use xlink:href="/files/cicons/cicons.svg?v=9#cross"></use></svg></a>' +
                    ...
                    "</div>" +
                '</div></div></div>' +
                '<svg id="i_' + this.books[forRBooks]["bid"] + '" class="arrow"><use xlink:href="/files/cicons/cicons.svg?v=9#arrow_left"></use></svg>' +
        ...
        '<svg id="i_0" class="arrow"><use xlink:href="/files/cicons/cicons.svg?v=9#arrow_left"></use></svg>' +
