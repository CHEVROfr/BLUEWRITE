                    ...
                    if(req.params.format && (req.params.format == "md" || req.params.format == "markdown")) {
                        ...
                        tools_webclient.getBooksDatalist(responseNote["note"]["book"]["bid"], req.session).then((htmlBooks) => {
                            ...
                            if(req.params.format && req.params.format == "pdf") {
                                ejsOptions["stylesheets"] = '<link rel="stylesheet" href="' + req.protocol + "://" + req.headers.host + '/files/css/general.css?v=11" />' +
                                                            '<link rel="stylesheet" href="' + req.protocol + "://" + req.headers.host + '/files/css/markdown.css?v=11" />' +
                                                            '<link rel="stylesheet" href="' + req.protocol + "://" + req.headers.host + '/files/css/note.css?v=11" />' +
                                                            '<link rel="stylesheet" href="' + req.protocol + "://" + req.headers.host + '/files/css/katex.min.css?v=11">'
                                if(req.query.theme && req.query.theme == "dark") {
                                    ejsOptions["stylesheets"] += '<link rel="stylesheet" media="print" href="' + req.protocol + "://" + req.headers.host + '/files/css/note-dark-print.css?v=11" />'
                                    ...
                                    ejsOptions["stylesheets"] += '<link rel="stylesheet" media="print" href="' + req.protocol + "://" + req.headers.host + '/files/css/note-light-print.css?v=11" />'
                                }
                                ...
                                ejsOptions["stylesheets"] = '<link rel="stylesheet" href="/files/css/codemirror.min.css?v=11" />' +
                                                            '<link rel="stylesheet" href="/files/css/general.css?v=11" />' +
                                                            '<link rel="stylesheet" href="/files/css/markdown.css?v=11" />' +
                                                            '<link rel="stylesheet" href="/files/css/note.css?v=11" />' +
                                                            '<link rel="stylesheet" href="/files/css/toastui-editor.custom.css?v=11" />' +
                                                            '<link rel="stylesheet" href="/files/css/note-light-print.css?v=11" />' +
                                                            '<link rel="stylesheet" href="/files/css/katex.min.css">'
                                ejsOptions["jsFiles"] = '<script src="/files/js/toastui-editor-all.custom.js?v=11"></script>' +
                                                        '<script src="/files/js/fullscreen.js?v=11"></script>' +
                                                        '<script src="/files/js/note_browserify.js?v=11"></script>'
                                ejsOptions["ciconsUrl"] = ciconsUrl
