...
Note = function(noteObj, sess) {
    ...
    this.getHtmlListDiv = function(withBook) {
        ...
        if(withBook) {
            ...
            html += '<a href="/notes?book=' + this.book.bid + '"class="noteBook"><svg><use xlink:href="/files/cicons/cicons.svg?v=11#book"></use></svg>' + htmlspecialchars(bookName) + '</a>'
        }        
...
search = (query) => {
    if(isSearching) {
        ...
        isSearching = true
        searchResults.innerHTML = '<div id="loading"><svg><use xlink:href="/files/cicons/cicons.svg?v=11#loading"></use></svg></div>'
